...
{
    // Class RangedUnit inherits from Unit class
    class RangedUnit : Unit
    {
        Map map;

        // RangedUnit constructor that inherits from Unit class
        public RangedUnit(int pos_X, int pos_Y, int health, int speed, int attack, int attackRange, string team, string symbol) : base(pos_X, pos_Y, health, speed, attack, attackRange, team, symbol)
        {
